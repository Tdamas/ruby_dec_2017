...
# Comment.create(content: "This is a comment from the 1st Blog", commentable: Blog.find(1))
#
# # Add comment for posts
# Comment.create(content: "This is a comment from the 9th Post", commentable: Post.find(9))
